...
# eventually converge on an internal state of 7.
...
cvrdt_1 = %VectorInts{id: 1, node_states: [0, 0, 0]}
cvrdt_2 = %VectorInts{id: 2, node_states: [0, 0, 0]}
cvrdt_3 = %VectorInts{id: 3, node_states: [0, 0, 0]}
...
cvrdt_1 = %VectorInts{id: 1, node_states: %{0 => 0, 1 => 0, 2 => 0}}
cvrdt_2 = %VectorInts{id: 2, node_states: %{0 => 0, 1 => 0, 2 => 0}}
cvrdt_3 = %VectorInts{id: 3, node_states: %{0 => 0, 1 => 0, 2 => 0}}
